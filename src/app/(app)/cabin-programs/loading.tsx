  ...
  return (
    <div className="animate-pulse">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="h-9 w-44 bg-[var(--muted)] rounded" />
      </div>
      <div className="h-9 w-full max-w-xl bg-[var(--muted)] rounded mb-4" />
      <div className="border border-[var(--border)] rounded-lg">
        <div className="h-10 bg-[var(--muted)] rounded-t-lg" />
        {Array.from({ length: 8 }, (_, i) => (
          <div key={i} className="h-11 border-t border-[var(--border)] flex items-center gap-4 px-4">
